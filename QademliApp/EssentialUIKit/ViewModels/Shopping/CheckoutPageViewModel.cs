...
using QademliApp.Models.Shopping;
using QademliApp.Models;
using QademliApp.AppLayout.Views;
using Template = QademliApp.AppLayout.Models.Template;
using QademliApp.Views.Shopping;

namespace QademliApp.ViewModels.Shopping
{
    /// <summary>
