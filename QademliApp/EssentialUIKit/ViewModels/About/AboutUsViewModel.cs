...
using QademliApp.Models.About;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace QademliApp.ViewModels.About
{
    /// <summary>
    ...
    public class AboutUsViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:QademliApp.ViewModels.About.AboutUsViewModel"/> class.
        /// </summary>
